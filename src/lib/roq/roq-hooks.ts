...
export function useShowFindMany<
  T extends Prisma.showFindManyArgs,
  R extends GetFindResult<Prisma.$showPayload<DefaultArgs>, T>[],
>(args?: Prisma.SelectSubset<T, Prisma.showFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useShowFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.show.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useShowCount<T extends Prisma.showCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.showCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useShowCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.show.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useShowFindManyWithCount<
  T extends Prisma.showFindManyArgs,
  R extends { data: GetFindResult<Prisma.$showPayload<DefaultArgs>, T>[]; count: number },
>(args?: Prisma.SelectSubset<T, Prisma.showFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useShowFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.show.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useShowFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useShowFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.show.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTheaterFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTheaterFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.theater.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTheaterCount<T extends Prisma.theaterCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.theaterCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTheaterCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.theater.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTheaterFindManyWithCount<
  T extends Prisma.theaterFindManyArgs,
  R extends { data: GetFindResult<Prisma.$theaterPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.theaterFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTheaterFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.theater.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTheaterFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTheaterFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.theater.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
