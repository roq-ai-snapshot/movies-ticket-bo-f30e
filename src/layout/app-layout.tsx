...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'owner', 'customer-service-representative'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Bookings', path: '/bookings', entity: 'booking', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    { name: 'Movies', path: '/movies', entity: 'movie', service: AccessServiceEnum.PROJECT, icon: FiFilm },
    { name: 'Shows', path: '/shows', entity: 'show', service: AccessServiceEnum.PROJECT, icon: FiClock },
    { name: 'Theaters', path: '/theaters', entity: 'theater', service: AccessServiceEnum.PROJECT, icon: FiHome },
